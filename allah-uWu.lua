-- // Lib \\ --
--[[
    local UI = loadstring(game:HttpGet("https://Allah.uWu.best/assets/files/gayasf.ui2?key=5y1lxXSfWKhlQkSqhUuFyB8kPp8hsCau"))()
]]
-- // Library Init \\ --
local Start = tick()
local LoadTime = tick()
...
do
    ...
    Utility.SaveConfig = function(Config)
        ...
        writefile(
            "Allah.uWu/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json", 
    ...
    Utility.LoadConfig = function(Config)
        local CFG = HttpService:JSONDecode(readfile("Allah.uWu/Configs/" .. tostring(game.PlaceId) .. "/" .. Config .. ".json"))
        --
...
do
    function Library.CreateLoader(Title, WindowSize)
        ...
        --
        Library.Theme.Logo = Utility.AddImage("Allah.uWu/Assets/UI/Logo2.png", "https://i.imgur.com/LbR3IoH.png") --ADRIAN
        --
        ...
        --
        Utility.AddFolder("Allah.uWu")
        Utility.AddFolder("Allah.uWu/Caches")
        Utility.AddFolder("Allah.uWu/Assets")
        Utility.AddFolder("Allah.uWu/Assets/UI")
        Utility.AddFolder("Allah.uWu/Configs")
        Utility.AddFolder("Allah.uWu/Scripts")
        --
        Library.Theme.Gradient = Utility.AddImage("Allah.uWu/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        -- Library.Theme.SecondIcon = Utility.AddImage("Allah.uWu/Assets/UI/Gradient.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/Gradient.png")
        Library.Theme.Hue = Utility.AddImage("Allah.uWu/Assets/UI/Hue.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/HuePicker.png")
        Library.Theme.Saturation = Utility.AddImage("Allah.uWu/Assets/UI/Saturation.png", "https://raw.githubusercontent.com/mvonwalk/Exterium/main/SaturationPicker.png")
        Library.Theme.SaturationCursor = Utility.AddImage("Allah.uWu/Assets/UI/HueCursor.png", "https://raw.githubusercontent.com/mvonwalk/splix-assets/main/Images-cursor.png")
        --
        Library.Theme.Dummy = Utility.AddImage("Allah.uWu/Assets/UI/Dummy.png", "https://i.imgur.com/6M6buVv.png")
        Library.Theme.Astolfo = Utility.AddImage("Allah.uWu/Assets/UI/Astolfo.png", "https://i.imgur.com/T20cWY9.png")
        Library.Theme.Aiko = Utility.AddImage("Allah.uWu/Assets/UI/Aiko.png", "https://i.imgur.com/1gRIdko.png")
        Library.Theme.Rem = Utility.AddImage("Allah.uWu/Assets/UI/Rem.png", "https://i.imgur.com/ykbRkhJ.png")
        Library.Theme.Violet = Utility.AddImage("Allah.uWu/Assets/UI/Violet.png", "https://i.imgur.com/7B56w4a.png")
        Library.Theme.Asuka = Utility.AddImage("Allah.uWu/Assets/UI/Asuka.png", "https://i.imgur.com/3hwztNM.png")
        --
        if not isfolder("Allah.uWu/Configs/" .. game.PlaceId) then
            makefolder("Allah.uWu/Configs/" .. game.PlaceId)
        end
        --
        ...
        function Window:Tab(Title)
            ...
            function Tab:Section(Title, Side)
                ...
                function Section:TextBox(Options)
                    ...
                    InputHandler.Name = ("Allah.uWu-INPUT-%s"):format(HttpService:GenerateGUID(false))
                    --
